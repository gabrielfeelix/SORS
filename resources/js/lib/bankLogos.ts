...
const bankLogoMap: Record<string, { svgFile: string | null; color: string }> = {
  ...
  'Itaú': { svgFile: 'Itaú/itau-oficial.png', color: '#EC7000' },
  'Itaú Unibanco': { svgFile: 'Itaú/itau-oficial.png', color: '#EC7000' },
  'Itaú Unibanco S.A.': { svgFile: 'Itaú/itau-oficial.png', color: '#EC7000' },
  'Banco Itaú': { svgFile: 'Itaú/itau-oficial.png', color: '#EC7000' },
  'Itau': { svgFile: 'Itaú/itau-oficial.png', color: '#EC7000' },

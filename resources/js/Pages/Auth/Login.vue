        ...
        <div class="flex flex-1 flex-col justify-center">
            <div class="mx-auto w-full max-w-md">
                <div class="flex flex-col items-center text-center lg:items-start lg:text-left">
                    <div
                        class="flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--kitamo-accent)] text-2xl font-bold text-white shadow-[0_18px_30px_-20px_rgba(20,184,166,0.85)] lg:hidden"
                    >
                        K
                    </div>
                    <h1 class="mt-5 text-2xl font-semibold text-[var(--kitamo-ink)] lg:text-3xl">E ai, bora entrar?</h1>
                    <p class="mt-2 text-sm text-slate-500">Cola aqui que a gente te ajuda a nao passar sufoco.</p>
                </div>
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            ...
                            <Link
                                ...
                                class="text-xs font-semibold text-[var(--kitamo-accent)]"
                            >
                                Esqueci minha senha
                            </Link>
                        </div>
